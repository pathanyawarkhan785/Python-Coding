...
1. Display
2. Insert from begin
3. Insert from between
4. Insert from last
5. Update Telephone
6. Delete except first
7. Delete first
8. Search
...
(Name : yawar , Telephone : 786)->(Name : y , Telephone : 1)
1. Display
2. Insert from begin
3. Insert from between
4. Insert from last
...
(Name : yawar , Telephone : 786)->(Name : y , Telephone : 1)->(Name : q , Telephone : 9)
1. Display
2. Insert from begin
3. Insert from between
4. Insert from last
